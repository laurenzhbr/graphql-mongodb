...
const rest_use_case_5 = async () => {
    ...
    const url = `http://${actualHost}/partyManagement/organization?organizationType=Marketing-%20und%20Vertriebspartner&status=validated&creditRating_gt=750&limit=10&sortBy=desc`;
