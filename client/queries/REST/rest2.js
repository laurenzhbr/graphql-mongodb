...
const rest_use_case_2 = async () => {
    ...
    const url = `http://${actualHost}/resourceInventoryManagement/resource?category=Street%20Cabinet&current_capacity_usage.gt=95fields=id,name,resourceCharacteristic`
