...
DB_NAME=$DB_NAME node server/utils/generateGeoAdressData.js
if [ $? -ne 0 ]; then
...
DB_NAME=$DB_NAME node server/utils/generateOrganization.js
if [ $? -ne 0 ]; then
...
DB_NAME=$DB_NAME node server/utils/generateCentralOffice.js
if [ $? -ne 0 ]; then
...
DB_NAME=$DB_NAME node server/utils/generateStreetCabinets.js
if [ $? -ne 0 ]; then
...
DB_NAME=$DB_NAME node server/utils/generateModem.js
if [ $? -ne 0 ]; then
...
DB_NAME=$DB_NAME node server/utils/generateRouter.js
if [ $? -ne 0 ]; then
...
DB_NAME=$DB_NAME node server/utils/generateDigitalIdentity.js
if [ $? -ne 0 ]; then
...
DB_NAME=$DB_NAME node server/utils/linkCoToSc.js
if [ $? -ne 0 ]; then
...
DB_NAME=$DB_NAME node server/utils/linkScToModem.js
if [ $? -ne 0 ]; then
...
DB_NAME=$DB_NAME node server/utils/linkModemToRouter.js
if [ $? -ne 0 ]; then
